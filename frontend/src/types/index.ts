...
export interface WeeklyRecap {start_date:string;end_date:string;mood_count:number;average_mood:number|null;top_tag:string;journal_count:number;assessment_count:number;moods_to_three:number}
